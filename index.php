                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php  while ($fila = mysqli_fetch_object($ejecutar))
                            ...
                            { 
                                ...
                                echo '<a class="collapse-item" href="categoriaconstruccion.php?id='.$fila->id_categoria.'">'.$fila->nombre_categoria.'</a>';
                            } 
                        ?>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"> <?php include("cerrar.php") ?></i>
                                    Salir
                                </a>
                            </div>
                        </li>
