...
function validar(){
    var nombre, correo, telefono, contraseña, contraseña2, expresion;
    ...
    if(nombre==="" || correo==="" || telefono==="" || contraseña=== "" || contraseña2=== "" ){
...
function validar1(){
    ...
    contraseña= document.getElementById("contraseña3").value;
